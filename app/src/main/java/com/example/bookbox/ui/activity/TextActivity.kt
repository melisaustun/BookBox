...
import com.example.bookbox.databinding.ActivityTextBinding
...
class TextActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setBackgroundDrawable(ColorDrawable(getResources().getColor(R.color.purple_500)));
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when (resultCode) {
            Activity.RESULT_OK -> {
                //Image Uri RESULT_OK için boş olmayacak
                val uri: Uri = data?.data!!

                // Depolama izinlerinden kaçınmak için Dosya yerine Uri nesnesini kullanır
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            // Varsayılan olarak arka kamerayı seçme
            val cameraSelector = CameraSelector.DEFAULT_BACK_CAMERA

            try {
                // Yeniden bağlamadan önce kullanım durumlarının bağlantısını kaldırma
                cameraProvider.unbindAll()

                // Kullanım durumlarını kameraya bağlama
                ...
                binding.apply {
                    ...
                    camera.apply {
                        torchImage.setBackgroundColor(resources.getColor(R.color.white))
                        ...
                        cameraInfo.torchState.observe(this@TextActivity) { torchState ->
