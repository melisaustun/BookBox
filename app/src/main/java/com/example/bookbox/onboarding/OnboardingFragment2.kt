...
import com.example.bookbox.databinding.FragmentOnboarding2Binding
...
class OnboardingFragment2 : Fragment() {
    ...
    // Bu özellik yalnızca onCreateView ve onDestroyView arasında geçerli
    private val binding get() = _binding!!
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Bu parça için düzeni inflate et
